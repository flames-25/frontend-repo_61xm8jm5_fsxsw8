...
export default function Navbar({ cartCount, onCartClick }) {
  return (
    <header className="sticky top-0 z-40 bg-[#fffdfa]/80 backdrop-blur border-b border-neutral-200/60">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button className="md:hidden p-2 rounded hover:bg-neutral-100"><Menu size={20} /></button>
          <div className="font-serif text-xl tracking-wide text-neutral-900">ComfyPal</div>
        </div>
